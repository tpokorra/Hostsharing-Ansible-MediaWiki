Hostsharing-Ansible-MediaWiki
=============================

This Ansible playbook will install the latest [MediaWiki](https://www.mediawiki.org/) release on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-MediaWiki.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-MediaWiki
